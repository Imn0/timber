/**
 * @file tmb_lib.h
 * @brief internal library
 *
 * this file contains internal library functionality
 * 1. os-definition
 * 2. ANSI values and operations
 * 3. advanced data types
 *    - dynamic array
 *    - string builder (specific dynami array)
 *    - string view
 *    - hashmap
 * 4. time measuring
 * 5. file utilities
